...
public class LeaveApplicationController {
    ...
    @Operation(summary = "快速审批通过离职申请")
    public Result<Void> quickApproveLeaveApplication(@PathVariable Long id) {
        leaveApplicationService.quickApproveLeaveApplication(id);

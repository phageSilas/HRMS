...
public class ContractCreateDTO {
    ...
    @Schema(description = "员工ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "5")
    ...
    @Schema(description = "合同类型：1-固定期限 2-无固定期限 3-劳务合同", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")

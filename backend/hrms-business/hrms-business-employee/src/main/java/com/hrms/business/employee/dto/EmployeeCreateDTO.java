...
public class EmployeeCreateDTO {
    ...
    @Schema(description = "手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "13900001111")
    ...
    @Schema(description = "所属部门ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "10")
    private Long deptId;
    ...
    @Schema(description = "入职日期", requiredMode = Schema.RequiredMode.REQUIRED, example = "2026-07-15")
